...
local CreditsBOX = GeneralTab:AddRightTabbox("Credits") do 
    ...
    Main:AddButton({ Text = 'Credits to violin-suzutsuki', Func = function() setclipboard('https://github.com/violin-suzutsuki/LinoriaLib'); Library:Notify('Copied Link') end, Tooltip = 'For creating this script' })
    Main:AddButton({ Text = 'Subscrube to MeatBoxing', Func = function() setclipboard('https://www.youtube.com/@meatboxing'); Library:Notify('Copied Link') end, Tooltip = 'For sharing this script' })
end
